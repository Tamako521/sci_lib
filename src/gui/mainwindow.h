...
private:
    ...
    // ===================== 全局原始数据 =====================
    Database m_db;             // src/common 数据库，作为 GUI 的统一数据源
    StatisticsAnalyzer m_stats; // src/analysis 统计模块
    AuthorGraph m_authorGraph;  // src/graph 作者合作图模块
    std::unique_ptr<SearchEngine> m_search; // src/search 搜索模块
